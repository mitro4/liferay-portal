					...
					strings: {
						setter: function(value) {
							return A.merge(
								value,
								{
									items: themeDisplay.getLanguageId() == 'ru_RU' ? '' : Liferay.Language.get('items'),
									next: Liferay.Language.get('next'),
									of: Liferay.Language.get('of'),
									page: themeDisplay.getLanguageId() == 'ru_RU' ? Liferay.Language.get('page-dp') : Liferay.Language.get('page'),
									per: Liferay.Language.get('per'),
									prev: Liferay.Language.get('previous'),
									results: themeDisplay.getLanguageId() == 'ru_RU' ? '' : Liferay.Language.get('results'),
